...
public interface IJournalEntryRepository
{
    ...
    Task<List<JournalEntry>> GetByTenantAsync(Guid tenantId, DateOnly? fromDate = null, DateOnly? toDate = null, EntryStatus? status = null, CancellationToken ct = default);
